...
function App() {
  return (
    <div className="min-h-screen text-studio-text selection:bg-studio-primary selection:text-white">
      ...
      <footer role="contentinfo" aria-label="Site altbilgisi" className="py-12 md:py-20 px-6 max-w-[1800px] mx-auto studio-border-t">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 md:gap-12">
          <div className="space-y-4">
             ...
             <p className="text-xs md:text-[10px] font-mono text-studio-gray uppercase tracking-widest leading-relaxed max-w-xs">
                Gelecek nesil endüstri liderleri için yüksek performanslı dijital ürünler tasarlıyoruz.
             </p>
          </div>
          
          <div className="flex flex-col md:items-end gap-2">
             <p className="text-xs md:text-[10px] font-mono text-studio-gray uppercase tracking-[0.2em]">© 2026 Lukeri Studio. Tüm hakları saklıdır.</p>
             <p className="text-xs md:text-[10px] font-mono text-studio-text font-bold uppercase tracking-[0.2em]">İstanbul | Bursa | Global Digital HQ</p>
          </div>
        </div>
      </footer>
    </div>
